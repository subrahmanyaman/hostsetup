...
//using namespace keymaster::javacard::test::sharedsecret;
//using namespace keymaster::javacard::test::secureclock;
//using ndk::ScopedAStatus;
using std::optional;
using std::shared_ptr;
using std::vector;

class JavacardKeyMintDevice : public IKeyMintDevice {
  public:
