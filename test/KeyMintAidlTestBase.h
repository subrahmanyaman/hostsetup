...
using ::android::sp;
using Status = keymaster::javacard::test::ScopedAStatus;
using ::std::optional;
...
class KeyMintAidlTestBase : public ::testing::TestWithParam<string> {
  public:
    ...
    string ProcessMessage(const vector<uint8_t>& key_blob, KeyPurpose operation,
                          ...
                          AuthorizationSet* out_params);
    std::tuple<ErrorCode, std::string /* processedMessage */>
    ...
    static vector<string> build_params() { return {"keymaster.javacard.test-host"}; }
    ...
    SecLevelAuthorizations(const vector<KeyCharacteristics>& key_characteristics);
