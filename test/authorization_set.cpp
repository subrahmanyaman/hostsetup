...
AuthorizationSetBuilder& AuthorizationSetBuilder::BlockMode(
    std::initializer_list<keymaster::javacard::test::BlockMode> blockModes) {
...
AuthorizationSetBuilder::Digest(std::vector<keymaster::javacard::test::Digest> digests) {
...
AuthorizationSetBuilder& AuthorizationSetBuilder::OaepMGFDigest(
    const std::vector<keymaster::javacard::test::Digest>& digests) {
    for (auto digest : digests) {
...
AuthorizationSetBuilder&
AuthorizationSetBuilder::Padding(std::initializer_list<PaddingMode> paddingModes) {
